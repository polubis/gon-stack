...
const navItems = [
  { icon: LayoutDashboard, label: copy.nav.dashboard, active: true },
...
export const Sidebar = () => (
  ...
  >
      ...
      <nav aria-label={copy.brand.name} className="mt-8 flex flex-col gap-1">
        {navItems.map(({ icon: Icon, label, active }) => (
          <a
            ...
            data-e2e={`dashboard:nav-${label.toLowerCase().replace(/\s+/g, '-')}`}
    ...
    <a
      href="#"
      data-e2e="dashboard:nav-settings"

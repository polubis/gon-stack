export const copy = {
  banner: {
    ...
    description:
      'We use essential cookies to keep Parka secure and working. Optional cookies help us understand how Parka is used and personalize your experience.',
  ...
  preferences: {
    ...
    categories: {
      ...
      analytics: {
        title: 'Analytics',
        description: 'Helps us understand how you use Parka.',
      },
      personalization: {

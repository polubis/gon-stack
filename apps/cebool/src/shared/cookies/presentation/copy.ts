export const copy = {
  banner: {
    ...
    description:
      'We use essential cookies to keep Cebool secure and working. Optional cookies help us understand how Cebool is used and personalize your experience.',
  ...
  preferences: {
    ...
    categories: {
      ...
      analytics: {
        title: 'Analytics',
        description: 'Helps us understand how you use Cebool.',
      },
      personalization: {
